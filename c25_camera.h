...
struct sm_vec2*  c25_screen_to_world(struct c25_camera*, 
	struct sm_vec2* world, const struct sm_ivec2* screen, int sw, int sh);
struct sm_ivec2* c25_world_to_screen(struct c25_camera*, 
	struct sm_ivec2* screen, const struct sm_vec3* world, int sw, int sh);
